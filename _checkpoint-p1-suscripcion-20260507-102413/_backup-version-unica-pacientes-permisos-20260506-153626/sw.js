const KLINIA_CACHE = "klinia-agenda-pacientes-permisos-v2";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=20260506-agenda-pacientes-permisos-v2",
  "./app.js?v=20260506-agenda-pacientes-permisos-v2",
