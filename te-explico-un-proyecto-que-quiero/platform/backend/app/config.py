...
class Settings(BaseSettings):
    ...
    google_calendar_rollout_clinic_ids: str = ""
    ...
    @property
    def google_calendar_rollout_clinic_id_set(self) -> set[str]:
        return {
            clinic_id.strip()
            for clinic_id in self.google_calendar_rollout_clinic_ids.split(",")
            if clinic_id.strip()
        }
